...
namespace Tool
{
   ...
   inline void SetRenderDrawColor(SDL_Renderer* Renderer_, Tool::Color Color) // Wrapper function for SDL_SetRenderDrawColor() that accepts the Color datatype
   {
      SDL_SetRenderDrawColor(Renderer_, Color.r, Color.g, Color.b, Color.a);
   }

   #ifdef USE_OPENGL
      inline void Tool_glClearColor(Tool::Color Color) // Wrapper function for glClearColor() that accepts the Color datatype
      {
   ...
   inline Color invertColor(Tool::Color Color, bool InvertAlpha = false) // Inverts Colors
   {
      ...
      {
         InvertedColor.r = abs(Color.r - 255);
         InvertedColor.g = abs(Color.g - 255);
         InvertedColor.b = abs(Color.b - 255);
